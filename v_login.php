...
<div class="container">
    ...
    <form class="form-signin" action="<?= site_url('login/cek_login')?>" method="post">
        <hr>
        <h4 class="form-signin-heading text-center">Aplikasi Penjualan Barang</h4>
    ...
    <hr>
    <div class="footer">
        <p>&copy; Created By : <a href="http://facebook.com/gilang.sonar" target="_blank"><strong>Amr Fauzan</strong></a></p>
    </div>
</div>
</body>
